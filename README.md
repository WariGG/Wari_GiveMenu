...
- **Self-giving permission**: Allow admins to give items to themselves by setting true/false.
- Item **count limit**: Set a limit on the number of items an admin can give at once (e.g., 500).
- **Translation** support: Customize the language for the menu using lang in config.
